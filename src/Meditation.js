    ...
    <main role="main" className="pt-0">
      <div className="app">
        ...
        <div className="player-container">
          ...
          <img ref={playRef} src="assets/svg/play.svg" alt="" className="play"onClick={handlePlayPause} />
          ...
          <img src="assets/svg/replay.svg" alt="" className="replay position-absolute bottom-0" onClick={handleReplay} />
